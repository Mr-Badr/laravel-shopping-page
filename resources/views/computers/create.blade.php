  ...
  <div class="flex justify-center pt-8">
    <form action="{{route('computers.store')}}" method="post" class="form bg-white p-6 border-1">
      ...
      <div>
        ...
        <input type="text" class="text-lg border-1" id="computer-name" value="{{old('computer-name')}}" name="computer-name">
        @error('computer-name')
      ...
      <div>
        ...
        <input type="text" class="text-lg border-1" id="computer-origin" value="{{old('computer-origin')}}" name="computer-origin">
      ...
      <div>
        ...
        <input type="text" class="text-lg border-1" id="computer-price" value="{{old('computer-price')}}" name="computer-price">
